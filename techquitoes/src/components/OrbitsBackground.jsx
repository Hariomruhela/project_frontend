...
const containerRef = useRef(null)
  ...
  const createOrbits = () => {
   ...
   const drawOrbit = (orbit) => {
    ...
    const drawParticle = (orbit, particle) => {
      const x =
        cx() +
  ...
  return (
    <div ref={containerRef} className={`fixed inset-0 overflow-hidden -top-24 bg-transparent ${className || ""}`}
>
      <canvas ref={canvasRef} className="absolute inset-0 h-full w-full -top-24" />
